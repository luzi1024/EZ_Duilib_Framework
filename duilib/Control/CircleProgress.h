...
public:
	...
	* @return 无
	*/
	void SetBackgroudColor(const ui::string& strColor);
	...
	* @return 无
	*/
	void SetForegroudColor(const ui::string& strColor);
	...
	* @return 无
	*/
	void SetCircleGradientColor(const ui::string& strColor);
	...
	* @return 无
	*/
	void SetIndicator(const ui::string& sIndicatorImage);
