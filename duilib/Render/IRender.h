...
public:
	...
	virtual void DrawColor(const UiRect& rc, const ui::string& colorStr, BYTE uFade = 255) = 0;
	...
	virtual void DrawText(const UiRect& rc, const ui::string& strText, DWORD dwTextColor, const ui::string& strFontId, UINT uStyle, BYTE uFade = 255, bool bLineLimit = false) = 0;
	...
	virtual UiRect MeasureText(const ui::string& strText, const ui::string& strFontId, UINT uStyle, int width = DUI_NOSET_VALUE) = 0;
